"""
Handjet ELSH interpolation (a word)
"""
...
def draw(txt="a", variations={}, caption=""):
    ...
    db.fill(*BACKCOL)
    db.rect(0, 0, w, h)
    fs = db.FormattedString(txt, font=handjetfont, fontSize=185, fontVariations=variations)
    db.fill(*TEXTCOL)
    db.stroke(None)
    path = db.BezierPath()
...
db.saveImage("../../docs/animations/Handjet-ELSH-animation_word.gif")
db.endDrawing()
