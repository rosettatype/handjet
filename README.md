...
The font may show unwanted visual artifacts in small sizes in Safari/Webkit. Change the default antialiasing setting in your CSS to eliminate them: `-webkit-font-smoothing: antialiased` (for example).
